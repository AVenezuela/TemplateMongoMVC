...
namespace TemplateMongo.SPA.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IApplicationUserService myService)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                ApplicationUser user = await _myService.FindUser(model.LoginBag.UserName, model.LoginBag.Password);
                if (user != null)
                {
                    await SignInAsync(user, model.LoginBag.RememberMe);
        ...
        private async Task SignInAsync(ApplicationUser user, bool isPersistent)
        {
            ...
            ClaimsIdentity identity = await _myService.CreateIdentityAsync(user, DefaultAuthenticationTypes.ApplicationCookie);
